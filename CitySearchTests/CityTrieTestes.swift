...
class CityTrieTests: XCTestCase {
    ...
    let cityAlangulam = City(identifier: 1279058, country: "IN", name: "Alangulam", coord: Coordinate(lat: 8.86667, lon: 77.5))
    let cityAlangayam = City(identifier: 1279061, country: "IN", name: "Alangayam", coord: Coordinate(lat: 12.6, lon: 78.75))
    let cityAlandur = City(identifier: 1279064, country: "IN", name: "Alandur", coord: Coordinate(lat: 13.0025, lon: 80.206108))
    let cityHokkaido = City(identifier: 1279064, country: "JP", name: "Hokkaidō", coord: Coordinate(lat: 43.06451, lon: 141.346603))
